...
- `se.quality/project/project.config.md`：人类可读的项目质量适配说明。
- `se.quality/project/quality.config.json`：机器可读的检查配置。
...
```text
se.quality/framework/guides/rules.md
se.quality/project/project.config.md
se.quality/project/quality.config.json
se.quality/project/STATUS.md
```
