...
| Stable Entry | Agent 的稳定入口文件，位于 `framework/prompts/*.md`，并由 prompt 指向后续 workflow。 | README.md, AGENTS.md |
| Workflow Guide | Agent 按 Stable Entry 指向读取的运行流程，通常是 `framework/guides/workflow.md`。 | README.md, AGENTS.md |
