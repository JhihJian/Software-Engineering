...
const intentionsDir = path.join(root, 'test-engineering', 'project', 'intentions');
const specDirs = [
  path.join(root, 'test-engineering', 'project', 'specs', 'api'),
  path.join(root, 'test-engineering', 'project', 'specs', 'contract'),
  path.join(root, 'test-engineering', 'project', 'specs', 'e2e'),
];
